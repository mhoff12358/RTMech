...
@export var m_desired_heading: float = 0
@export var m_desired_heading_adjust_speed: float = 180
...
func apply_waist_rotation_to_body():
    m_character_body.rotation = m_waist.rotation
    m_waist.rotation = 0
